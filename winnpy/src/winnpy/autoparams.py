...
def auto_select(
    ...
    """Returns (best_data, best_params); lightweight version consistent with the grid in winn.py."""
    ...
    for bopt in batch_options:
        ...
        for tname in tests:
            for acfdr in acorr_fdrs:
                X2 = autocorrelation_correct(X1, run_order, current_batch, lag, tname,
                                             detrend_non_autocorrelated, acfdr)
